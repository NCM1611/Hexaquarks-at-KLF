...
TH1D* delta_dist_1D=new TH1D("delta_dist_1D","Distribution for delta decay (1D)",200,1,1.6);
TRandom3 rndgen;
...
Double_t Masses_1[2] = {0.939,0.134};
...
delta_dist-> SetTitle("Distribution Delta Decay (Proton #pi^{0} branch); Mass [GeV/c^{2}]; BW Value");

delta_dist->Draw("");

TCanvas* c3 = new TCanvas("c3","stacked hists",5,5,1000,1000);

delta_dist_1D-> SetTitle("Distribution Delta Decay (Proton #pi^{0} branch, 1D); Mass [GeV/c^{2}]; Weight");
