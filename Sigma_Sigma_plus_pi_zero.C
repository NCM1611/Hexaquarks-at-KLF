...
TH2D* Sigma_plus_dist=new TH2D("Sigma_plus_Sigma_pi","Breit-Wigner Distribution of #Sigma^{*+} (#Sigma #pi branch)",800,1,1.8,800,0,1);
TH1D* Sigma_plus_dist_1D=new TH1D("Sigma_plus_Sigma_pi_1D","Breit-Wigner Distribution of #Sigma^{*+} (#Sigma #pi branch 1D)",800,1,1.8);
TRandom3 rndgen;
...
Double_t Masses_1[2] = {1.189,0.134}; //Sigma masses average to around 1190 MeV
...
Sigma_plus_dist_1D-> SetTitle("Breit-Wigner Distribution of #Sigma^{*+} (#Sigma + #pi 0 decay branch, 1D); Mass [GeV/c^{2}]; Breit-Wigner Value");
