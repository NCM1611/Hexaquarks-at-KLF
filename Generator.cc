...
//Numbers here are from the GEANT3 Particle Ids. Obseleate but it is still used.
#define G3ID_prot 14
#define G3ID_neut 13
...
#define G3ID_deuteron 45
#define G3ID_antineut 25

//Numbers are from the PDG Monte-Carlo particle numbering scheme here
//Will need to look into adding a deuteron target into code. 2014 PDG value for it was 1000010020 - Seems to be ok for it.
...
#define PDGID_deuteron 1000010020
#define PDGID_antineut -2112
...
int main (int argc, char **argv){
    ...
    } //Add dss otpion to keyword reaction_t (both lines- same location for ease).
    enum keywordReaction_t {kl1,kl2,kl3,kl4,kl5,kl6,kl7,kl8,kln1,kln2,kln3,kln4,kln5,kln6,kln7,kln8,ds1,ds2,ds3,ds4,g1,g2,g3,n1,n2,n3,n4,n5,n6}; //reaction keyword
    char* keywordReaction [] = {"kl1","kl2","kl3","kl4","kl5","kl6","kl7","kl8","kln1","kln2","kln3","kln4","kln5","kln6","kln7","kln8","ds1","ds2","ds3","ds4","g1","g2","g3","n1","n2","n3","n4","n5","n6", NULL }; //reaction keyword
    int   ReactionKey=0;
    ...
    //ADD DSS PARTICLE REACTION CASE HERE
    switch ((keywordReaction_t) ReactionKey) {
        ...
        case kln8:
            ...
            fermi=1;
            break;
//DS AND DSS REACTIONS PLACED HERE
//TEST DS REACTIONS PROTOTYPES:
       case ds1: //DOING DELTA PLUS SIGMA ZERO TO N pi + Lambda pi
	   num_tracks=6;
           beamType = KLong;
           beamMass=mass_kaonzeroPDG;
           geant_ID.push_back(G3ID_kaonlong); //BEAM
           geant_ID.push_back(G3ID_deuteron); //Target
	   geant_ID.push_back(G3ID_lambd);
	   geant_ID.push_back(G3ID_pizero);
           geant_ID.push_back(G3ID_neut);
           geant_ID.push_back(G3ID_piplus);
           ...
           pdg_ID.push_back(PDGID_kaonlong);
           pdg_ID.push_back(PDGID_deuteron);
           pdg_ID.push_back(PDGID_lambd);//
           pdg_ID.push_back(PDGID_pizero);//
           pdg_ID.push_back(PDGID_neut);//
           pdg_ID.push_back(PDGID_piplus);//
	   ...
	   charge.push_back(1);
           ...
           FSmasses=new double[num_tracks-4];
           FSmasses[0]=mass_lambdPDG;
           FSmasses[1]=mass_pizeroPDG;
	   FSmasses[2]=mass_neutPDG;
	   FSmasses[3]=mass_piplusPDG;
           break;

       case ds2: //DOING DELTA ++ SIGMA - TO p pi^+ + Lambda pi^- + antineutron with a proton target
           num_tracks=7;
           beamType = KLong;
           beamMass=mass_kaonzeroPDG;
           geant_ID.push_back(G3ID_kaonlong); //BEAM
           geant_ID.push_back(G3ID_prot); //Target
           geant_ID.push_back(G3ID_lambd);
           geant_ID.push_back(G3ID_pizero);
           geant_ID.push_back(G3ID_neut);
           geant_ID.push_back(G3ID_piplus);
           geant_ID.push_back(G3ID_antineut);  //EXTRA PARTICLE PRODUCED FOR BARYON NUM CONSERVATION
           ...
           pdg_ID.push_back(PDGID_neut);//
           pdg_ID.push_back(PDGID_piplus);//
	   pdg_ID.push_back(PDGID_antineut); //Had to add
	   ...
	   charge.push_back(0);
           ...
           FSmasses=new double[num_tracks-5];
           FSmasses[0]=mass_lambdPDG;
           FSmasses[1]=mass_pizeroPDG;
           FSmasses[2]=mass_neutPDG;
           FSmasses[3]=mass_piplusPDG;
	   FSmasses[4]=mass_neutPDG; //Antiparticle has same mass as neutron so can use this val here
           break;
//MOST PROBABLE DECUPLET AND OCTET BRANCH DECAYS FOR DS:
	case ds3: //Decuplet-Decuplet decay of ds, most probable branch
           num_tracks=6;
           beamType = KLong;
           beamMass=mass_kaonzeroPDG;
           geant_ID.push_back(G3ID_kaonlong); //BEAM
           ...
           FSmasses=new double[num_tracks-4];
           FSmasses[0]=mass_protPDG;
           FSmasses[1]=mass_piplusPDG;
           FSmasses[2]=mass_lambdPDG;
           FSmasses[3]=mass_pizeroPDG;
           break;

	case ds4: //Octet-Octet decay of ds, most probable branch
           num_tracks=4;
           beamType = KLong;
           beamMass=mass_kaonzeroPDG;
           geant_ID.push_back(G3ID_kaonlong); //BEAM
